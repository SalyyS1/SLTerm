...
import (
	...
	"github.com/SalyyS1/SLTerm/pkg/jobmanager"
)

var jobManagerCmd = &cobra.Command{
	Use:    "jobmanager",
	Hidden: true,
	Short:  "job manager for sl terminal",
	Args:   cobra.NoArgs,
	RunE:   jobManagerRun,
}
...
func jobManagerRun(cmd *cobra.Command, args []string) error {
	...
	publicKeyB64 := os.Getenv("SLTERM_PUBLICKEY")
	if publicKeyB64 == "" {
		return fmt.Errorf("SLTERM_PUBLICKEY environment variable is not set")
	}

	publicKeyBytes, err := base64.StdEncoding.DecodeString(publicKeyB64)
	if err != nil {
		return fmt.Errorf("failed to decode SLTERM_PUBLICKEY: %v", err)
	}
