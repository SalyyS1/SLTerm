...
export const WaveAppPathVarName = "SLTERM_APP_PATH";
export const WaveAppResourcesPathVarName = "SLTERM_RESOURCES_PATH";
export const WaveAppElectronExecPath = "SLTERM_ELECTRONEXECPATH";
