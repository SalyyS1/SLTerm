...
declare global {
    ...
    // wshrpc.AIToolsInventoryData
    type AIToolsInventoryData = {
        skills: AIToolsItemData[];
        agents: AIToolsItemData[];
        commands: AIToolsItemData[];
        mcp: AIToolsMCPServerData[];
        warnings?: string[];
    };

    // wshrpc.AIToolsInventoryRequestData
    type AIToolsInventoryRequestData = {
        projectdir?: string;
    };

    // wshrpc.AIToolsItemContentData
    type AIToolsItemContentData = {
        content: string;
    };

    // wshrpc.AIToolsItemData
    type AIToolsItemData = {
        kind: string;
        name: string;
        scope: string;
        path: string;
    ...
    // wshrpc.AIToolsItemRefData
    type AIToolsItemRefData = {
        kind: string;
        scope: string;
        name: string;
        projectdir?: string;
    ...
    // wshrpc.AIToolsMCPServerData
    type AIToolsMCPServerData = {
        name: string;
        transport: string;
        command?: string;
        args?: string[];
    ...
    // wshrpc.AIToolsWriteItemData
    type AIToolsWriteItemData = {
        kind: string;
        scope: string;
        name: string;
        projectdir?: string;
    ...
    // wshrpc.AgentTeamsMemberData
    type AgentTeamsMemberData = {
        agentId: string;
        name: string;
        agentType: string;
        model?: string;
    ...
    // wshrpc.AgentTeamsSnapshotData
    type AgentTeamsSnapshotData = {
        teams: AgentTeamsTeamData[];
        warnings?: string[];
    };

    // wshrpc.AgentTeamsTaskData
    type AgentTeamsTaskData = {
        id: string;
        subject: string;
        status: string;
        owner?: string;
    ...
    // wshrpc.AgentTeamsTasksRequestData
    type AgentTeamsTasksRequestData = {
        teamname: string;
    };

    // wshrpc.AgentTeamsTeamData
    type AgentTeamsTeamData = {
        dirname: string;
        name: string;
        description?: string;
        createdAt?: number;
        leadAgentId?: string;
        members: AgentTeamsMemberData[];
        tasks: AgentTeamsTaskData[];
    };
    ...
    // wshrpc.PetDialogueResponseData
    type PetDialogueResponseData = {
        text: string;
        type: string;
    };

    // wshrpc.PetInteractData
    type PetInteractData = {
        action: string;
    };

    // wshrpc.PetProfileData
    type PetProfileData = {
        activePetId: string;
    ...
    // wshrpc.PetSelectData
    type PetSelectData = {
        petId: string;
    };

    // wshrpc.PetSessionData
    type PetSessionData = {
        startedAt: string;
        activeTime: number;
        commandCount: number;
