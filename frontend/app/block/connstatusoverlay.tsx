...
const StalledOverlay = React.memo(
    ({
        ...
        return (
            <div
                className="@container absolute top-[calc(var(--header-height)+6px)] left-1.5 right-1.5 z-[var(--zindex-block-mask-inner)] overflow-hidden rounded-md bg-[var(--conn-status-overlay-bg-color)] shadow-lg opacity-90"
