...
class RpcApiType {
    ...
    GetWaveAIChatCommand(client: WshClient, data: CommandGetWaveAIChatData, opts?: RpcOpts): Promise<any> {
    ...
    GetWaveAIRateLimitCommand(client: WshClient, opts?: RpcOpts): Promise<any> {
