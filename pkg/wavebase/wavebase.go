...
const (
	WaveConfigHomeEnvVar           = "SLTERM_CONFIG_HOME"
	WaveDataHomeEnvVar             = "SLTERM_DATA_HOME"
	WaveAppPathVarName             = "SLTERM_APP_PATH"
	WaveAppResourcesPathVarName    = "SLTERM_RESOURCES_PATH"
	WaveAppElectronExecPathVarName = "SLTERM_ELECTRONEXECPATH"
	WaveDevVarName                 = "SLTERM_DEV"
	WaveDevViteVarName             = "SLTERM_DEV_VITE"
	WaveWshForceUpdateVarName      = "SLTERM_WSHFORCEUPDATE"
	WaveNoConfirmQuitVarName       = "SLTERM_NOCONFIRMQUIT"

	WaveJwtTokenVarName  = "SLTERM_JWT"
	WaveSwapTokenVarName = "SLTERM_SWAPTOKEN"
)
...
var ConfigHome_VarCache string          // caches SLTERM_CONFIG_HOME
var DataHome_VarCache string            // caches SLTERM_DATA_HOME
var AppPath_VarCache string             // caches SLTERM_APP_PATH
var AppResourcesPath_VarCache string    // caches SLTERM_RESOURCES_PATH
var AppElectronExecPath_VarCache string // caches SLTERM_ELECTRONEXECPATH
var Dev_VarCache string                 // caches SLTERM_DEV
...
const RemoteWaveHomeDirName = ".slterm"
const RemoteWshBinDirName = "bin"
const RemoteFullWshBinPath = "~/.slterm/bin/wsh"
const RemoteFullDomainSocketPath = "~/.slterm/wave-remote.sock"
...
func GetPersistentRemoteSockName(clientId string) string {
	return fmt.Sprintf("~/.slterm/client/%s/slterm.sock", clientId)
}
...
func GetRemoteJobSocketPath(jobId string) string {
	socketDir := filepath.Join("/tmp", fmt.Sprintf("slterm-%d", os.Getuid()))
...
func GetRemoteJobLogDir() string {
	homeDir := GetHomeDir()
	jobDir := filepath.Join(homeDir, ".slterm", "jobs")
	return jobDir
}
