...
import (
	...
	"github.com/SalyyS1/SLTerm/pkg/util/daystr"
	"github.com/SalyyS1/SLTerm/pkg/wavebase"
)

const WCloudEndpoint = "https://api.github.com/SalyyS1/SLTerm/central"
const WCloudEndpointVarName = "WCLOUD_ENDPOINT"
const WCloudWSEndpoint = "wss://wsapi.github.com/SalyyS1/SLTerm/"
const WCloudWSEndpointVarName = "WCLOUD_WS_ENDPOINT"
const WCloudPingEndpoint = "https://ping.github.com/SalyyS1/SLTerm/central"
...
func CacheAndRemoveEnvVars() error {
	// SLTerm: cloud endpoints are optional, never fail on missing vars
...
func checkEndpointVar(endpoint string, debugName string, varName string) error {
	// SLTerm: always return nil, cloud is optional
	return nil
}
