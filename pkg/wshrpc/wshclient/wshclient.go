...
import (
	...
	"github.com/SalyyS1/SLTerm/pkg/vdom"
)
...
// command "agentteamsgetsnapshot", wshserver.AgentTeamsGetSnapshotCommand
func AgentTeamsGetSnapshotCommand(w *wshutil.WshRpc, opts *wshrpc.RpcOpts) (*wshrpc.AgentTeamsSnapshotData, error) {
	resp, err := sendRpcRequestCallHelper[*wshrpc.AgentTeamsSnapshotData](w, "agentteamsgetsnapshot", nil, opts)
	return resp, err
}

// command "agentteamsgettasks", wshserver.AgentTeamsGetTasksCommand
func AgentTeamsGetTasksCommand(w *wshutil.WshRpc, data wshrpc.AgentTeamsTasksRequestData, opts *wshrpc.RpcOpts) ([]wshrpc.AgentTeamsTaskData, error) {
	resp, err := sendRpcRequestCallHelper[[]wshrpc.AgentTeamsTaskData](w, "agentteamsgettasks", data, opts)
	return resp, err
}
...
// command "aitoolsdeleteitem", wshserver.AIToolsDeleteItemCommand
func AIToolsDeleteItemCommand(w *wshutil.WshRpc, data wshrpc.AIToolsItemRefData, opts *wshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "aitoolsdeleteitem", data, opts)
	return err
}

// command "aitoolsgetinventory", wshserver.AIToolsGetInventoryCommand
func AIToolsGetInventoryCommand(w *wshutil.WshRpc, data wshrpc.AIToolsInventoryRequestData, opts *wshrpc.RpcOpts) (*wshrpc.AIToolsInventoryData, error) {
	resp, err := sendRpcRequestCallHelper[*wshrpc.AIToolsInventoryData](w, "aitoolsgetinventory", data, opts)
	return resp, err
}

// command "aitoolsreaditem", wshserver.AIToolsReadItemCommand
func AIToolsReadItemCommand(w *wshutil.WshRpc, data wshrpc.AIToolsItemRefData, opts *wshrpc.RpcOpts) (*wshrpc.AIToolsItemContentData, error) {
	resp, err := sendRpcRequestCallHelper[*wshrpc.AIToolsItemContentData](w, "aitoolsreaditem", data, opts)
	return resp, err
}

// command "aitoolswriteitem", wshserver.AIToolsWriteItemCommand
func AIToolsWriteItemCommand(w *wshutil.WshRpc, data wshrpc.AIToolsWriteItemData, opts *wshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "aitoolswriteitem", data, opts)
	return err
}
...
func GetWaveAIChatCommand(w *wshutil.WshRpc, data wshrpc.CommandGetWaveAIChatData, opts *wshrpc.RpcOpts) (interface {}, error) {
	resp, err := sendRpcRequestCallHelper[interface {}](w, "getwaveaichat", data, opts)
	return resp, err
}
...
func GetWaveAIRateLimitCommand(w *wshutil.WshRpc, opts *wshrpc.RpcOpts) (interface {}, error) {
	resp, err := sendRpcRequestCallHelper[interface {}](w, "getwaveairatelimit", nil, opts)
	return resp, err
}
...
// command "petaddxp", wshserver.PetAddXPCommand
func PetAddXPCommand(w *wshutil.WshRpc, data wshrpc.PetXPData, opts *wshrpc.RpcOpts) (*wshrpc.PetStateData, error) {
	resp, err := sendRpcRequestCallHelper[*wshrpc.PetStateData](w, "petaddxp", data, opts)
	return resp, err
}

// command "petgetcatalogue", wshserver.PetGetCatalogueCommand
func PetGetCatalogueCommand(w *wshutil.WshRpc, opts *wshrpc.RpcOpts) ([]wshrpc.PetCatalogueEntryData, error) {
	resp, err := sendRpcRequestCallHelper[[]wshrpc.PetCatalogueEntryData](w, "petgetcatalogue", nil, opts)
	return resp, err
}

// command "petgetdialogue", wshserver.PetGetDialogueCommand
func PetGetDialogueCommand(w *wshutil.WshRpc, data wshrpc.PetDialogueRequestData, opts *wshrpc.RpcOpts) (*wshrpc.PetDialogueResponseData, error) {
	resp, err := sendRpcRequestCallHelper[*wshrpc.PetDialogueResponseData](w, "petgetdialogue", data, opts)
	return resp, err
}

// command "petgetprofile", wshserver.PetGetProfileCommand
func PetGetProfileCommand(w *wshutil.WshRpc, opts *wshrpc.RpcOpts) (*wshrpc.PetProfileData, error) {
	resp, err := sendRpcRequestCallHelper[*wshrpc.PetProfileData](w, "petgetprofile", nil, opts)
	return resp, err
}

// command "petgetsession", wshserver.PetGetSessionCommand
func PetGetSessionCommand(w *wshutil.WshRpc, opts *wshrpc.RpcOpts) (*wshrpc.PetSessionData, error) {
	resp, err := sendRpcRequestCallHelper[*wshrpc.PetSessionData](w, "petgetsession", nil, opts)
	return resp, err
}

// command "petgetstate", wshserver.PetGetStateCommand
func PetGetStateCommand(w *wshutil.WshRpc, opts *wshrpc.RpcOpts) (*wshrpc.PetStateData, error) {
	resp, err := sendRpcRequestCallHelper[*wshrpc.PetStateData](w, "petgetstate", nil, opts)
	return resp, err
}

// command "petinteract", wshserver.PetInteractCommand
func PetInteractCommand(w *wshutil.WshRpc, data wshrpc.PetInteractData, opts *wshrpc.RpcOpts) (*wshrpc.PetStateData, error) {
	resp, err := sendRpcRequestCallHelper[*wshrpc.PetStateData](w, "petinteract", data, opts)
	return resp, err
}

// command "petselectpet", wshserver.PetSelectPetCommand
func PetSelectPetCommand(w *wshutil.WshRpc, data wshrpc.PetSelectData, opts *wshrpc.RpcOpts) (*wshrpc.PetStateData, error) {
	resp, err := sendRpcRequestCallHelper[*wshrpc.PetStateData](w, "petselectpet", data, opts)
	return resp, err
}
